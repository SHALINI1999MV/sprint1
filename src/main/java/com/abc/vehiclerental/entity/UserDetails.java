...
public class UserDetails {
	...
	@Pattern(regexp = "[A-Z]{1}[a-zA-Z0-9 *@#]+", message = "first letter should be capital. Number alphabets and special characters are to be included")
	...
	private List<Booking_Details> bookings;

	@OneToMany(mappedBy = "user")
	private List<ManageFeedback> manageQuery;
	...
	public List<ManageFeedback> getManageQuery() {
		return manageQuery;
	}

	public void setManageQuery(List<ManageFeedback> manageQuery) {
	...
	public void setBookings(List<Booking_Details> bookings) {
